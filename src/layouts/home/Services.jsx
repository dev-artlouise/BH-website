import { Box, Container, Typography, Skeleton, Grid, Paper, CardContent } from "@mui/material";
import CarouselComponent from "../../components/common/CarouselComponent";
import PaperCardComponent from "../../components/common/PaperCardComponent";
import { useServiceListSection, useServiceSection } from "../../hooks/useMainPage";
...
const Services = () => {
    const { isLoading: isServicesLoading, error: isServicesError, data: services } = useServiceListSection();
    const { isLoading: isServiceLoading, error: isServiceError, data: service } = useServiceSection();
